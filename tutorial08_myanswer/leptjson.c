    ...
    switch (src->type) {
        ...
        case LEPT_OBJECT:
            ...
            for (i = 0; i < src->u.o.size; i++){
                dst->u.o.m[i].k = (char*)malloc(src->u.o.m->klen + 1);
                memcpy(dst->u.o.m[i].k, src->u.o.m[i].k, src->u.o.m->klen);
                dst->u.o.m[i].k[src->u.o.m->klen] = '\0';
    ...
    switch (lhs->type) {
        ...
        case LEPT_OBJECT:
            ...
            for (i = 0; i < lhs->u.o.size; i++){
                rhs_index = lept_find_object_index(rhs, lhs->u.o.m[i].k, lhs->u.o.m[i].klen);
                if ((rhs_index == LEPT_KEY_NOT_EXIST)
                    ||!lept_is_equal(&lhs->u.o.m[i].v, &rhs->u.o.m[rhs_index].v))
                    return 0;
            }
            return 1;
        default:
...
void lept_shrink_object(lept_value* v) {
    ...
    if (v->u.o.capacity > v->u.o.size) {
        ...
        v->u.o.m = (lept_member*)realloc(v->u.o.m, v->u.a.capacity * sizeof(lept_member));
    }
}
...
lept_value* lept_set_object_value(lept_value* v, const char* key, size_t klen) {
    size_t index = lept_find_object_index(v, key, klen), size = v->u.o.size;
    assert(v != NULL && v->type == LEPT_OBJECT && key != NULL);
    /* \todo */
...
void lept_remove_object_value(lept_value* v, size_t index) {
    ...
    for(i = index + 1; i < v->u.o.size; i++)
        memcpy(&v->u.o.m[i-1], &v->u.o.m[i], sizeof(lept_member));
